...
export default function Button({children,disabled,to,type}) {
  ...
  const base = "bg-yellow-300 uppercase font-semibold text-stone-800  inline-block tracking-wide rounded-full hover:bg-yellow-200 transition-colors duration-300 focus:outline-none focus:ring focus:ring-yellow-300 focus-ring-offset-2 disabled:cursor-not-allowed"
  const styles = {
